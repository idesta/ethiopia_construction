...
export function SceneVilla({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 400 380"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-label="Villa House"
    >
...
export function SceneApartment({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 400 460"
      fill="none"
...
export function SceneRoad({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 400 340"
      fill="none"
...
export function SceneTallBuilding({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 400 500"
      fill="none"
...
export function SceneSafetyGear({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 400 380"
      fill="none"
    ...
    >
      ...
      <path
        d="M100 200 Q100 100 200 82 Q300 100 300 200 Z"
        fill={a}
        opacity="0.88"
      />
      <rect
      ...
      />
      <path
        d="M122 145 Q200 118 278 145"
        stroke="rgba(255,255,255,0.22)"
        strokeWidth="5"
        fill="none"
      />
      <path
        d="M140 240 L120 340 L200 320 L280 340 L260 240 L220 260 L200 250 L180 260 Z"
        fill="#1c1f27"
        stroke={a}
        strokeWidth="1.2"
      />
      ...
      <path
        d="M110 260 Q80 255 72 275 Q68 295 90 298 Q108 300 115 280 Z"
        fill="#1c1f27"
        stroke={a}
        strokeWidth="1"
      />
      <path
        d="M290 260 Q320 255 328 275 Q332 295 310 298 Q292 300 285 280 Z"
        fill="#1c1f27"
        stroke={a}
        strokeWidth="1"
      />
...
export function SceneBulldozer({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 440 300"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-label="Bulldozer"
    >
      <style>{`
      ...
      <g className="blade">
        <path
          d="M60 148 L110 138 L110 198 L60 210 Z"
          fill="#1c1f27"
          stroke={a}
          strokeWidth="1.5"
        />
      ...
      <path
        d="M310 180 L350 172 L356 218 L310 218 Z"
        fill="#1c1f27"
        stroke={a}
        strokeWidth="1"
      />
...
export function SceneExcavator({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 460 320"
      fill="none"
    ...
    >
      ...
      <g className="arm2">
        <rect
          ...
          fill={a}
          opacity="0.6"
          transform="rotate(20 360 120)"
        />
        <path
          d="M406 148 L428 138 L436 162 L412 174 Z"
          fill="#14161b"
          stroke={a}
          strokeWidth="1.2"
          transform="rotate(20 360 120)"
...
export function SceneTruck({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 480 280"
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M160 80 L390 80 L410 200 L140 200 Z"
        fill="#1c1f27"
        stroke={a}
        strokeWidth="1.2"
      />
...
export function SceneEngineer({ a }: { a: string }) {
  return (
    <svg
      viewBox="0 0 400 420"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-label="Civil Engineer"
    >
      <style>{`
      ...
      <g className="head">
        ...
        />
        <path
          d="M190 96 Q200 104 210 96"
          stroke={a}
          strokeWidth="1.5"
          fill="none"
        />
        <path
          d="M168 78 Q168 50 200 46 Q232 50 232 78 Z"
          fill={a}
          opacity="0.9"
        />
        <rect
      ...
      />
      <path
        d="M148 130 L200 124 L252 130 L268 258 L132 258 Z"
        fill="#14161b"
        stroke={a}
        strokeWidth="1.2"
      />
      ...
      />
      <path
        d="M148 140 L100 210 L114 216 L158 154 Z"
        fill="#1c1f27"
        stroke={a}
        strokeWidth="0.8"
      />
      <path
        d="M252 140 L300 210 L314 204 L242 136 Z"
        fill="#1c1f27"
        stroke={a}
        strokeWidth="0.8"
      />
...
/* ═══════════════════════════════════════════════════════════════════
   ...
   Used as fallback when no hero scenes are uploaded for a tenant.
   ═══════════════════════════════════════════════════════════════════ */
/* ═══════════════════════════════════════════════════════════════════
   BUILT-IN SCENE REGISTRY
   Used as fallback when no hero scenes are uploaded for a tenant, AND
   as the picker source for hero_slides with media_type='builtin_scene'
   (HeroSlideshow resolves a slide's stored `media_ref` key through
   `getBuiltinScene` below). `key` is the stable identifier stored in
   the database; `label` is just display text and is safe to reword
   later without breaking any stored slide.
   ═══════════════════════════════════════════════════════════════════ */
export const BUILTIN_SCENES: {
  key: string;
  label: string;
  Component: React.FC<{ a: string }>;
}[] = [
  { key: "crane", label: "Tower Crane", Component: SceneCrane },
  { key: "villa", label: "Villa House", Component: SceneVilla },
  { key: "apartment", label: "Apartment Block", Component: SceneApartment },
  { key: "road", label: "Asphalt Road", Component: SceneRoad },
  {
    key: "tall-building",
    label: "Tall Buildings",
    Component: SceneTallBuilding,
  },
  { key: "safety-gear", label: "Safety Gear", Component: SceneSafetyGear },
  { key: "bulldozer", label: "Bulldozer", Component: SceneBulldozer },
  { key: "excavator", label: "Excavator", Component: SceneExcavator },
  { key: "truck", label: "Dump Truck", Component: SceneTruck },
  { key: "engineer", label: "Civil Engineer", Component: SceneEngineer },
];

export function getBuiltinScene(key: string | null | undefined) {
  return BUILTIN_SCENES.find((s) => s.key === key);
}
