...
export function SceneRoad({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 400 340" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Road">
      ...
      <line x1="0" y1="240" x2="400" y2="240" strokeDasharray="30 15" strokeWidth="3" stroke={a} opacity="0.6" className="road-dash"/>
...
export function SceneSafetyGear({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 400 380" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Safety Gear">
      ...
      <line x1="148" y1="270" x2="252" y2="270" stroke={a} strokeWidth="6" opacity="0.7" strokeLinecap="round"/>
      <line x1="145" y1="292" x2="255" y2="292" stroke={a} strokeWidth="6" opacity="0.5" strokeLinecap="round"/>
...
/* ═══════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════ */
export const BUILTIN_SCENES: { label: string; Component: React.FC<{ a: string }> }[] = [
